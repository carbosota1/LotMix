...
OUT_CSV  = "La Primera History.csv"
OUT_XLSX = "La Primera History.xlsx"
...
def write_checkpoint_snapshot(src_csv: str, start_d: date, end_d: date):
    if not os.path.exists(src_csv):
        return
    snap_name = f"La Primera History__{start_d.isoformat()}__{end_d.isoformat()}.csv"
